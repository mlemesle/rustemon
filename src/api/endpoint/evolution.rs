...
pub mod evolution_chain {
    crate::api::endpoint::endpoint::endpoint!(crate::api::model::evolution::EvolutionChain; for "evolution-chain");
}
...
pub mod evolution_trigger {
    crate::api::endpoint::endpoint::endpoint!(crate::api::model::evolution::EvolutionTrigger; for "evolution-trigger");
}
