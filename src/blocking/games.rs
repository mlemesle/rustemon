...
pub mod generation {
    crate::blocking::endpoint!(crate::model::games::Generation; for "generation");
}
...
pub mod pokedex {
    crate::blocking::endpoint!(crate::model::games::Pokedex; for "pokedex");
}

/// Versions of the games, e.g., Red, Blue or Yellow.
pub mod version {
    crate::blocking::endpoint!(crate::model::games::Version; for "version");
}

/// Version groups categorize highly similar versions of the games.
pub mod version_group {
    crate::blocking::endpoint!(crate::model::games::VersionGroup; for "version-group");
}
