...
pub mod ability {
    crate::blocking::endpoint!(crate::model::pokemon::Ability; for "ability");
}
...
pub mod characteristic {
    crate::blocking::endpoint!(crate::model::pokemon::Characteristic; for "characteristic");
}
...
pub mod egg_group {
    crate::blocking::endpoint!(crate::model::pokemon::EggGroup; for "egg-group");
}
...
pub mod gender {
    crate::blocking::endpoint!(crate::model::pokemon::Gender; for "gender");
}

/// Growth rates are the speed with which Pokémon gain levels through experience.
/// Check out [Bulbapedia](http://bulbapedia.bulbagarden.net/wiki/Experience) for greater detail.
pub mod growth_rate {
    crate::blocking::endpoint!(crate::model::pokemon::GrowthRate; for "growth-rate");
}

/// Natures influence how a Pokémon's stats grow. See [Bulbapedia](http://bulbapedia.bulbagarden.net/wiki/Nature) for greater detail.
pub mod nature {
    crate::blocking::endpoint!(crate::model::pokemon::Nature; for "nature");
}
...
pub mod pokeathlon_stat {
    crate::blocking::endpoint!(crate::model::pokemon::PokeathlonStat; for "pokeathlon-stat");
}
...
pub mod pokemon {
    crate::blocking::endpoint!(crate::model::pokemon::Pokemon; for "pokemon"; with (encounters, Vec<crate::model::pokemon::LocationAreaEncounter>));
}
...
pub mod pokemon_color {
    crate::blocking::endpoint!(crate::model::pokemon::PokemonColor; for "pokemon-color");
}
...
pub mod pokemon_form {
    crate::blocking::endpoint!(crate::model::pokemon::PokemonForm; for "pokemon-form");
}
...
pub mod pokemon_habitat {
    crate::blocking::endpoint!(crate::model::pokemon::PokemonHabitat; for "pokemon-habitat");
}

/// Shapes used for sorting Pokémon in a Pokédex.
pub mod pokemon_shape {
    crate::blocking::endpoint!(crate::model::pokemon::PokemonShape; for "pokemon-shape");
}
...
pub mod pokemon_species {
    crate::blocking::endpoint!(crate::model::pokemon::PokemonSpecies; for "pokemon-species");
}
...
pub mod stat {
    crate::blocking::endpoint!(crate::model::pokemon::Stat; for "stat");
}
...
pub mod type_ {
    crate::blocking::endpoint!(crate::model::pokemon::Type; for "type");
}
